...
(function ($) {
    ...
    $.fn.Collapzion = function (options) {
        ...
        _base.init = function () {
            ...
            _base.append('<a role="button" aria-label="open communication" style="background-color:' + _settings._main_btn_color + '" href="javascript:void(0)" class="_col_shadow _collapz_parant _close contactFire"></a>');
